            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-8">
                    <div class="flex justify-between items-center bg-gray-100 p-2 rounded mb-2">
                        ...
                        <form action="{{ route('pendidikan.destroySemester', urlencode($semester ?: 'Tanpa Semester')) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus SEMUA data Pendidikan pada semester ini?');">
                            @csrf
                            @method('DELETE')
